...
def create_default_preferences(user_id, cursor, conn):
    ...
    default_prefs = {
        ...
        'nutrition_display_order': 'calories,protein,carbs,fat,fiber',
        'goal_protein_percentage': '15',
        'goal_carbs_percentage': '50',
        'goal_fat_percentage': '35',
        'weekly_weight_goal': '0',  # kg per week
        'preferred_meal_times': '{"breakfast":"07:00","lunch":"12:00","dinner":"19:00"}',
